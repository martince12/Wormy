...
def runGame():
    ...
    for i in range(WALL_NUM):
        while True:
            ...
            if wall not in walls and wall not in wormCoords:
                walls.append(wall)
                break
    ...
    while True:
        ...
        # Check collisions with walls or edges
        if (newHead['x'] < 0 or newHead['x'] >= CELLWIDTH or
                newHead['y'] < 0 or newHead['y'] >= CELLHEIGHT):
            return  # hit screen edge

        for wall in walls:
            if wall['x'] == newHead['x'] and wall['y'] == newHead['y']:
                return  # hit a wall
...
def showGameOverScreen():
    ...
    gameRect.center = (WINDOWWIDTH / 2, WINDOWHEIGHT / 2 - 80)
    overRect.center = (WINDOWWIDTH / 2, WINDOWHEIGHT / 2 + 20)
